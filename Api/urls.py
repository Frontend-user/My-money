...
urlpatterns = [
    ...
    path('categories/categories_expense_open/', views.categories_expense_open, name='categories_expense_open'),

    path('categories/categories_open/expense_add/', views.expense_add, name='expense_add'),
